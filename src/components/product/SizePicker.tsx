          ...
          return (
            <button
              ...
              className={`flex min-w-11 flex-col items-center rounded-lg border px-3 py-1.5 text-sm font-medium transition-colors ${
                isOutOfStock
                  ? 'cursor-not-allowed border-stone-200 bg-stone-100 text-stone-600 line-through'
                  : isActive
            ...
            >
              {size}
              {!isOutOfStock && (
                <span className={`text-[10px] font-normal ${isActive ? 'text-white/80' : 'text-stone-600'}`}>
